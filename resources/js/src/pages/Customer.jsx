...
const Customer = () => {
  ...
  return (
        ...
        <div className="row px-xl-5">
            <div className="col-12">
                <nav className="breadcrumb bg-light mb-30">
                    ...
                    <span className="breadcrumb-item active"><a href="/customerregister">Register New</a></span>
                </nav>
            </div>
        </div>
    </div>
    ...
    <div className="container-fluid">
        <h2 className="section-title position-relative text-uppercase mx-xl-5 mb-4"><span className="bg-secondary pr-3">Customer Login</span></h2>
        <div className="row px-xl-5">
                ...
                <div className="contact-form bg-light p-30">
                    ...
                    <form name="form1" method="post" onSubmit={handleFormSubmit}>
                        <div className="control-group">
                            <input type="text" className="form-control" name="uname" placeholder="Username" onChange={handleChange}
                                required="required" />
                            
                        </div>
						<p></p>
                        <div className="control-group">
                            <input type="password" className="form-control" name="pass" placeholder="Password" onChange={handleChange}
                                required="required" />

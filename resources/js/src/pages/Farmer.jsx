...
const Farmer = () => {
    const [inputs, setInputs] = useState({
      ...
      const handleFormSubmit = (event) => {
        ...
        axios.post('http://127.0.0.1:8000/api/loginfarmer', inputs)
          .then((response) => {
  ...
  return (
        ...
        <div className="row px-xl-5">
            <div className="col-12">
                <nav className="breadcrumb bg-light mb-30">
                    ...
                    <span className="breadcrumb-item active"><a href="/register">Register New</a></span>
                </nav>
            </div>
        </div>
    </div>
    ...
    <div className="container-fluid">
        <h2 className="section-title position-relative text-uppercase mx-xl-5 mb-4"><span className="bg-secondary pr-3">Hotel Login</span></h2>
        <div className="row px-xl-5">

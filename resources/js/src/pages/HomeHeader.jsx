                ...
                <span className="h1 text-uppercase text-primary bg-dark px-2">Food</span>
                    ...
                    <div className="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div className="navbar-nav mr-auto py-0">
                            ...
                            <a href="/login" className="nav-item nav-link">Hotel</a>
                            <a href="/customerlogin" className="nav-item nav-link">Customer</a>
							<a href="/adminlogin" className="nav-item nav-link">Admin</a>
